        ...
        <div className='container'  >
            <div className='row'>
                ...
                <div className='col-3 col-md-2 text-center'>
                    ...
                    <p style={{fontSize:22,fontWeight:'bold'}}>Shake</p>
                </div>
                <div className='col-3 col-md-2 text-center'>
                    ...
                    <p style={{fontSize:22,fontWeight:'bold'}}>Biryani</p>
                </div>
                <div className='col-3 col-md-2 text-center'>
                    ...
                    <p style={{fontSize:22,fontWeight:'bold'}}>Burger</p>
                </div>
                <div className='col-3 col-md-2 text-center'>
                    ...
                    <p style={{fontSize:22,fontWeight:'bold'}}>Fried Rice</p>
                </div>
                <div className='col-3 col-md-2 text-center'>
                    ...
                    <p style={{fontSize:22,fontWeight:'bold'}}>Pizza</p>
                </div>
                <div className='col-3 col-md-2 text-center'>
                    ...
                    <p style={{fontSize:22,fontWeight:'bold'}}>Chicken</p>
                </div>
